...
Cuando un nuevo responsable asume la comunicación audiovisual de una empresa, la auditoría inicial es la forma más eficiente de entender la situación de partida: qué existe, qué funciona, qué no funciona y qué debería cambiar. Sin ese diagnóstico, los primeros meses se gastan en aprender por ensayo y error lo que una auditoría revela en una semana.

> **// El coste de no hacer el diagnóstico**
> Cada mes de producción audiovisual sin diagnóstico es un mes de inversión con criterio incierto. No es que el dinero se pierda necesariamente —parte del contenido siempre genera algo. Es que sin diagnóstico, no hay forma de saber si se está obteniendo el máximo retorno posible de esa inversión, ni qué cambiar para mejorarla.
